...
- If attack type is SQL injection, write rules to sqli.conf, If attack type is XSS, write rules to xss.conf, If attack type is Command Injection, write rules to cmdi.conf, If attack type is Path Traversal, write rules to path_traversal.conf
